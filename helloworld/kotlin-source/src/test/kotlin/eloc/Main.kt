...
/*val (controller, issuer, advisory, buyer, seller) = listOf(
                ...
                val seller = startNode(providedName = CordaX500Name("airline", "London", "GB"), rpcUsers = listOf(user)).getOrThrow()
                val buyer = startNode(providedName = CordaX500Name("flightInsurer","London", "GB"), rpcUsers = listOf(user)).getOrThrow()
